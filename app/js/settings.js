module.exports = {
  ...
  enabledLangs: ["en"],
  mainDomain: "bioatlas.biodiversitydata.se", // used for cookies (without http/https)
  mainLAUrl: "https://bioatlas.biodiversitydata.se",
  baseFooterUrl: "https://bioatlas.biodiversitydata.se",
